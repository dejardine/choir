...
const sectionClasses = computed(() => {
  let alignClass = "medium-gallery--left"; // default
  ...
  if (props.slice.primary.align_gallery) {
    ...
    alignClass = `medium-gallery--${alignValue}`;
  }

  return {
    "medium-gallery-slice": true,
...
onMounted(() => {
  if (swiperRef.value) {
    ...
    console.log("MediumGallery swiper instance:", swiperInstance);
    console.log("MediumGallery pagination options:", paginationOptions.value);
